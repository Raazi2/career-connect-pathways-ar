        ...
        <div className="w-full h-[500px] relative bg-muted/30 rounded-lg overflow-hidden">
          <div className="absolute inset-0" ref={sceneRef}>
            <a-scene embedded vr-mode-ui="enabled: true">
              ...
              {/* Add text labels */}
              <a-text value="Engineering Lab" position="-1 1.5 -3" color="#FFF" scale="0.5 0.5 0.5"></a-text>
              <a-text value="Healthcare" position="0 2.5 -5" color="#FFF" scale="0.5 0.5 0.5"></a-text>
              <a-text value="Construction" position="1 2 -3" color="#FFF" scale="0.5 0.5 0.5"></a-text>
            </a-scene>
          </div>
        </div>
