...
// Note: A-Frame works by registering custom HTML elements, so we need to make sure
// it's only loaded in the browser environment
        ...
        <div className="mt-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div className="bg-gray-50 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-gray-600">Explore medical tools and environments</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg text-center">
              <h3 className="font-medium">Engineering</h3>
              <p className="text-sm text-gray-600">Interact with 3D mechanical objects</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg text-center">
              <h3 className="font-medium">Architecture</h3>
              <p className="text-sm text-gray-600">Visualize building designs in space</p>
            </div>
          </div>
        </div>
      </CardContent>
